...
create table facturas (FacturaNumero int primary key auto_increment ,TotalImpuestos float not null,total float not null,SumaTotal float not null,fecha DATE not null,MetodoPago varchar(50) not null,Moneda varchar(50) not null,RFC_Clientes varchar(50) not null,RFC_provedor varchar(50) not null,ruta varchar(100) not null);



insert into clientes values("123","ROMAN");
